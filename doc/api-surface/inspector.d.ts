 ...
 */
export { createInspector, type InspectorBundle, type InspectorEntry, type InspectorOptions, type InspectorView, type TimelineEvent, type TimelineEventKind, } from './inspector.js';
